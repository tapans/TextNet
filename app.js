			...
			for (var j = 0; j < numSteps; j++){
				...
				switch(step.travel_mode.toLowerCase){
					...
					case "transit":						
						...
						mssg += printTransitStep(stepNum, agency, departureStopName, departureTime, arrivalStopName, arrivalTime, numStops, summary);
						numSteps++;
						break;
					case "default":
						mssg += printStep(stepNum, step.html_instructions, step.distance.text, step.duration.text);	
...
function printTransitStep(stepNum, agency, departureStopName, departureTime, arrivalStopName, arrivalTime, numStops, summary){
	var line = stepNum + ". " + agency + ": " + summary + " (" + numStops + " stops). ";
	line += "Depart " + departureStopName + " at" + departureTime + " and arrive at " + arrivalStopName + " at " + arrivalTime + "\n";
	return line;
}